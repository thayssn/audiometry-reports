...
export const formatReportContent = (report: Report): string => {
    const sections = [
        ...
        `**Data de Nascimento:** ${formatDateUTC(report.identification.birth_date)}\n` +
        `**Data de Admissão:** ${formatDateUTC(report.identification.admission_date)}\n` +
        `**Data do Último Exame Sequencial:** ${formatDateUTC(report.identification.last_sequential_exam_date)}\n` +
